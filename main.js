...
lib.ssMetadata = [
		{name:"main_atlas_", frames: [[3393,1470,79,116],[3628,0,395,677],[0,0,2305,1330],[3365,1377,429,91],[3365,1158,426,109],[2961,1470,430,79],[3365,1269,436,106],[2356,1013,603,726],[2961,1013,1059,143],[3628,679,304,295],[3190,1158,173,274],[3969,1158,97,149],[3954,1457,84,137],[3969,1309,96,146],[3803,1158,164,154],[3934,848,153,157],[3934,679,159,167],[3803,1314,149,155],[2307,0,1319,1011],[0,1332,2354,231],[2961,1158,227,276]]}
];
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-71,-44,0.739,0.767);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(378.4,886.8,1.704,1.704,0,0,0,14.1,31.3);

	this.instance_3 = new lib.movingFlower1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(1035.2,874.6,1.704,1.704,0,0,0,17.2,32.1);

	this.instance_4 = new lib.movingFlower();
	this.instance_4.parent = this;
	this.instance_4.setTransform(603.5,811.8,1.704,1.704,0,0,0,20.4,30.9);
	...
	this.instance_5.setTransform(428.3,603.9,1.592,1.592,0,0,0,143.2,172.5);
	...
	this.instance_6.setTransform(1274.5,948.3,1.588,1.588);
	...
	this.instance_7.setTransform(1089.8,432.2,1.588,1.588,0,0,0,16.4,24);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.clip_mc},{t:this.instance_6}]}).wait(1));

	// 화산
	this.instance_8 = new lib.sprite1_0013_왼쪽고양이();
	this.instance_8.parent = this;
	this.instance_8.setTransform(526,1043,0.747,0.747);

	this.instance_9 = new lib.volcano();
	this.instance_9.parent = this;
	this.instance_9.setTransform(1070.3,458.4,1.704,1.704,0,0,0,298.2,228.5);

	this.instance_10 = new lib.sprite1_0023_바닥();
	this.instance_10.parent = this;
	this.instance_10.setTransform(12,828,0.643,0.643);

	this.instance_11 = new lib.cloud();
	this.instance_11.parent = this;
	this.instance_11.setTransform(1706.1,423.9,1.588,1.588,0,0,0,261.9,35.4);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/main_atlas_.png?1537114890157", id:"main_atlas_"}
	],
	preloads: []
};
